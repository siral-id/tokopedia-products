...
import {ITokopediaPdpShopFeature, ITokopediaPdpShopInfo, ITokopediaPdpShopPackSpeed, ITokopediaPdpShopTopChatSpeed, ITokopediaPdpShopRatingsQuery} from "./shop.ts"
...
export interface ITokopediaRecommendationProductSchema extends ITokopediaRecommendationProduct {
  _id: Bson.ObjectId;
  source: string;
}
